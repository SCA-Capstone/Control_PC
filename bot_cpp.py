    ...
    def get_cpp_jobs(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if submitted_jobs:
                    print(
                        'Submitted jobs with config "C++" retrieved successfully:', submitted_jobs)
                    return submitted_jobs
                else:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for job_id in ids:
            ...
            ["g++", "cpp_files/test.cpp", "-o", "cpp_files/test.exe"],
            capture_output=True,
            text=True
            )
            ...
            # Step 2: Execute the compiled C++ program, capturing stdout and stderr
